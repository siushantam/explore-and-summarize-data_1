...
### Description One
The distribution of residual sugar (log 10) in white wines appears to be bi-modal and the modes happen at 0.1 & 0.9 (log10 of g/dm^3).  It might indicate that the demand of white wines come in two ranges of sweetness levels.  Some prefer less sweet, some prefer more.
...
### Description Two
It can be noticed that after quality rating 5, quality improves in general as alcohol % increases.  E.g. at rating 5, the median alcohol % is around 9.5%.  When quality gets higher, the alcohol % moves up eventually to around 12.5%.  But the number of data point gets really thin at two ends so statistically, we have less confidence there.
